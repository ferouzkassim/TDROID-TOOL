...
"color: rgb(255, 255, 255);")
        ...
        self.pitline = QtWidgets.QLineEdit(self.frame)
        self.pitline.setGeometry(QtCore.QRect(210, 80, 771, 41))
        self.pitline.setObjectName("pitline")
        self.apline = QtWidgets.QLineEdit(self.frame)
        self.apline.setGeometry(QtCore.QRect(210, 220, 771, 41))
        self.apline.setObjectName("apline")
        self.blline = QtWidgets.QLineEdit(self.frame)
        self.blline.setGeometry(QtCore.QRect(210, 150, 771, 41))
        self.blline.setObjectName("blline")
        self.cpline = QtWidgets.QLineEdit(self.frame)
        self.cpline.setGeometry(QtCore.QRect(210, 290, 771, 41))
        self.cpline.setObjectName("cpline")
        self.cscline = QtWidgets.QLineEdit(self.frame)
        self.cscline.setGeometry(QtCore.QRect(210, 360, 771, 41))
        self.cscline.setObjectName("cscline")
        self.userdataline = QtWidgets.QLineEdit(self.frame)
        self.userdataline.setGeometry(QtCore.QRect(210, 440, 771, 41))
        self.userdataline.setObjectName("userdataline")
        self.pitcheckbox = QtWidgets.QCheckBox(self.frame)
        self.pitcheckbox.setGeometry(QtCore.QRect(10, 80, 132, 29))
        self.pitcheckbox.setObjectName("pitcheckbox")
        self.apcheckbox = QtWidgets.QCheckBox(self.frame)
        self.apcheckbox.setGeometry(QtCore.QRect(10, 240, 132, 29))
        self.apcheckbox.setObjectName("apcheckbox")
        self.cpcheckbox = QtWidgets.QCheckBox(self.frame)
        self.cpcheckbox.setGeometry(QtCore.QRect(10, 310, 132, 29))
        self.cpcheckbox.setObjectName("cpcheckbox")
        self.userdtacheckbox = QtWidgets.QCheckBox(self.frame)
        self.userdtacheckbox.setGeometry(QtCore.QRect(10, 450, 181, 31))
        self.userdtacheckbox.setObjectName("userdtacheckbox")
        self.csccheckbox = QtWidgets.QCheckBox(self.frame)
        self.csccheckbox.setGeometry(QtCore.QRect(10, 380, 132, 29))
        self.csccheckbox.setObjectName("csccheckbox")
        self.blcheckbox = QtWidgets.QCheckBox(self.frame)
        self.blcheckbox.setGeometry(QtCore.QRect(10, 160, 132, 29))
